            ...
            <v-layout justify-center align-center>
                ...
                <v-card v-show="!loader" style="width: 100%;">
                    <v-card-title>
                        ...
                        <!-- <v-spacer></v-spacer> -->
                        <v-tooltip right>
                            <v-btn icon v-slot:activator="{ on }" class="mx-0" @click="getRoles">
                    ...
                    <v-data-table :headers="headers" :items="roles" class="elevation-1" :search="search" :loading="isLoading">
                        ...
                        <template slot="items" slot-scope="props">
                            ...
                            <td class="justify-center layout px-0">
                                <v-tooltip bottom>
                                    <v-btn v-slot:activator="{ on }" icon class="mx-0" @click="openEdit(props.item)">
                                        <v-icon small color="blue darken-2">edit</v-icon>
                                    </v-btn>
                                    <span>Edit</span>
                                </v-tooltip>
                                <v-tooltip bottom>
                                    <v-btn v-slot:activator="{ on }" icon class="mx-0" @click="deleteItem(props.item)">
